...
class RecommendationControllerTest {
    ...
    void getRecommendations() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/recommendation/{userId}", userId))
                ...
                .andExpect(jsonPath("$.recommendations[0]").value(recommendationName))
                .andExpect(jsonPath("$.recommendations[1]").value(recommendationId))
                .andExpect(jsonPath("$.recommendations[2]").value(recommendationText));
    }
}